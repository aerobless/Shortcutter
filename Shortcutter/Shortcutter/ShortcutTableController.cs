...
{
	public class ShortcutTableModel : MonoMac.AppKit.NSWindowController
	{
		...
		public ShortcutTableModel (IntPtr handle) : base(handle)
		{
			Initialize ();
		}
		...
		public ShortcutTableModel (NSCoder coder) : base(coder)
		{
			Initialize ();
		}

		// Call to load from the XIB/NIB file
		public ShortcutTableModel () : base("TableEdit")
		{
			Initialize ();
		}
		...
		public NSMutableDictionary edit(NSDictionary startingValues, MainWindowController sender)
		{
			...
			var editFields = ShortcutTable.Cells;
